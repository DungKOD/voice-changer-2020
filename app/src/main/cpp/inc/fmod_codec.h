...
typedef struct FMOD_CODEC_DESCRIPTION
{
    ...
    FMOD_CODEC_GETLENGTH_CALLBACK     getlength;       /* [w] EffectItemCallback to return the length of the song in whatever format required when Sound::getLength is called. */
    ...
    FMOD_CODEC_GETWAVEFORMAT_CALLBACK getwaveformat;   /* [w] EffectItemCallback to tell FMOD about the waveformat of a particular subsound.  This is to save memory, rather than saving 1000 FMOD_CODEC_WAVEFORMAT structures in the codec, the codec might have a more optimal way of storing this information. */
