...
typedef struct FMOD_DSP_STATE_FUNCTIONS
{
    ...
    FMOD_DSP_GETLISTENERATTRIBUTES_FUNC getlistenerattributes;  /* [r] EffectItemCallback for getting the absolute listener attributes set via the API (returned as left-handed co-ordinates). */
