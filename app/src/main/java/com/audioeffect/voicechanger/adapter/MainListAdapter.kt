...
import com.recodereffect.voicechanger.utils.*
...
class MainListAdapter(context: Context) : RecyclerView.Adapter<MainListAdapter.ListViewHolder>() {
    ...
    private val originalBg: Int by bindColor(context, R.color.c_blue_text_dialog)
    private val expandedBg: Int by bindColor(context, R.color.c_blue_text_dialog)
    ...
    private val modelListFiltered = modelList.filter {
        it.id !in filteredItems
    }
